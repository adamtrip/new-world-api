    ...
    where T : class, IAggregateRoot
{
    ...
    {
        return _decorated.FirstOrDefaultAsync<TResult>(specification, cancellationToken);
    }
    ...
    {
        return _decorated.SingleOrDefaultAsync<TResult?>(specification, cancellationToken);
    }
