...
{
    public async Task<string> ForgotPasswordAsync(ForgotPasswordRequest request, string callbackUrl)
    {
        //EnsureValidTenant();
        ...
        var mailRequest = new MailRequest(
            ...
            _t["Reset Password"],
            _t[$"Your Password Reset Token is '{code}'. You can reset your password using the {callbackUrl} Endpoint."]);
