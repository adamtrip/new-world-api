    ...
    IEventNotificationHandler<ApplicationRoleUpdatedEvent>
{
    ...
    public async ValueTask Handle(EventNotification<ApplicationUserUpdatedEvent> notification, CancellationToken cancellationToken)
    {
    ...
    public async ValueTask Handle(EventNotification<ApplicationRoleUpdatedEvent> notification, CancellationToken cancellationToken)
    {
