...
{
    public class IceMagicAbilityTable : AuditableEntity, IAggregateRoot
    {
        ...
        public string TargetStatusEffectPotency { get; set; }
        public string TargetStatusEffectPotencyComparison { get; set; }
        ...
        public int? MaxNumAroundMe { get; set; }
