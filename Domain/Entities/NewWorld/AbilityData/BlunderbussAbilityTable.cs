...
{
    public class BlunderbussAbilityTable : AuditableEntity, IAggregateRoot
    {
        ...
        public int? ResetConsecutiveOnSuccess { get; set; }
        ...
        public string StatusEffectDamageTableIdForRowOverride { get; set; }
